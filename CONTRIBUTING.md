# Contributing to Kiota Abstractions for Ruby
...
|------|-------------|--------------|
| `fix` | Bug fix | Patch (`0.14.4` → `0.14.5`) |
| `feat` | New feature | Minor (`0.14.4` → `0.15.0`) |
| `feat!`, `fix!`, `refactor!`, etc. | Breaking change (append `!`) | Minor while pre-1.0 (`0.14.4` → `0.15.0`) |
